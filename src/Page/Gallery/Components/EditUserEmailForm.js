  ...
  return (
    <div className='fixed z-50 bottom-0 left-0 w-full'>
      ...
      <motion.div 
        ...
        exit={{ opacity: 0, y: -20 }}
        className='bg-gray-900 border border-white/30   rounded-md p-4 box-border text-white fixed top-[20%] left-1/2 -translate-x-1/2 w-4/5 overflow-y-auto max-h-[85vh]'
      >

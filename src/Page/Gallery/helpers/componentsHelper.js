  ...
  return (
    <div className=" fixed z-50 top-0 left-0 w-full">
      ...
      <motion.div
        ...
        className="  bg-gray-800 rounded-md  p-4 box-border border border-white/20 text-white fixed top-1/3 left-1/2 -translate-x-1/2 w-4/5 md:w-auto overflow-y-auto max-h-[85vh]"
      >
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="my-3 relative mx-2  mx-auto">
            <div className="flex justify-between mb-2">
              ...
              <button className="ml-auto" onClick={handleCopyPrompt}>
                <MdContentCopy />
              </button>
            </div>

            <div className="text-xs p-2 bg-gray-600 rounded-md  mx-auto">
    ...
    <div className=" fixed z-50 top-0 left-0 w-full">
      ...
      >
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="text-white/70 text-xs mt-1 mb-4">
            當您要使用這些功能時，需要登入網站。
          </div>
          <div className="mt-6 flex flex-col gap-3 justify-center text-md">
            <div
              onClick={handleLogin}
              className=" bg-t_lime-600 cursor-pointer px-5 py-2 rounded-md hover:bg-gray-600"
            >
              現在登入
            </div>
            <button
...
export const TestImageModal = () => {
  return (
    <div className=" fixed top-0 left-0 lg:right-0 lg:bottom-0 flex z-50 bg-gray-800 h-screen overflow-y-auto">
      <div className="00 p-4 max-w-screen-lg mx-auto  gap-3 text-white/80 relative my-5">
        <div className="flex   justify-center items-center ">
          <div className="w-full h-full">
            <img
              src="https://r2.web.moonshine.tw/msweb/moonshotai/static/134b166/18079489419501_0.jpg"
              alt="18079489419501_0.jpg"
        ...
        <div className="flex flex-col justify-end pt-5 relative pb-20 ">
          ...
          <div className="text-white font-bold my-3 flex gap-2 items-center">
            Model
            <div className="bg-gray-700  px-3  py-1 rounded-md">selec</div>
          </div>
          <div className="text-white font-bold my-3">Prompt</div>
          <div className="bg-gray-700 p-3 rounded-md">
            selectedImage.prompt selectedImage.prompt selectedImage.prompt
            selectedImage.prompt selectedImage.prompt selectedImage.prompt
            selectedImage.prompt selectedImage.prompt selectedImage.prompt
            selectedImage.prompt selectedImage.prompt selectedImage.prompt
            selectedImage.prompt selectedImage.prompt selectedImage.prompt
        ...
        <div className="flex left-0 gap-2 justify-center items-center py-4 fixed bottom-0 z-50 w-full bg-gray-800">
          <button className="bg-gray-600 text-white px-2 py-1 rounded-md w-1/2 ">
            Copy Prompt
          </button>
          <button className="  bg-gray-800 text-white px-2 py-1 rounded-md hover:bg-gray-700 focus:bg-gray-700">
            Close
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex flex-col">
          <input
            type="text"
            placeholder="即將上線"
            className="bg-gray-700 rounded-xl py-3 px-2 text-sm"
            disabled
          />
        </div>
        <button
          type="submit"
          disabled
          className="disabled flex justify-center items-center bg-gray-700 text-white/30 rounded-xl py-3 px-4 text-center  text-xl"
        >
          輸入邀請碼(即將上線)
    ...
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-2">
          ...
          <button
            type="submit"
            className="flex justify-center items-center bg-gradient-to-r from-lime-700 to-lime-600 rounded-xl py-3 px-4 text-center text-white text-xl"
          >
            輸入邀請碼
            <MdOutlineTrendingFlat className="ml-2" />
          </button>
...
export const GenerateInvite = () => {
  return (
    <div className=" flex ">
      <button
        type="submit"
        className="w-full flex justify-center items-center bg-gradient-to-r from-lime-700 to-lime-600 rounded-xl py-3 px-4 text-center text-white text-xl"
      >
        <div>
          產生邀請碼
...
export const DisableBuyButton = () => {
  return (
    <button
      disabled
      className="w-full flex justify-center items-center bg-gray-700 text-white/30 rounded-xl py-6 px-4 text-center  text-xl"
    >
      即將開賣
      <MdOutlineTrendingFlat className="ml-2" />
    </button>
      ...
      {!userData ? (
        ...
        <div className="flex flex-col items-center gap-5 relative text-white">
          ...
          <div className="" onClick={handleFollow}>
            {isFollowed ? (
              <button className="bg-lime-600 px-5 py-2 rounded-md">
                Following
              </button>
            ) : (
              <button className="bg-lime-700 px-5 py-2 rounded-md">
                Follow
              </button>
            )}
          </div>
            ...
            <div className="w-12" key={"c" + index}>
              <div className="pt-[100%] relative">
                <img
                  src={item.url}
                  alt=""
                  className="absolute top-1/2 left-0 -translate-y-1/2 object-cover w-full h-fulls  border border-gray-400"
  ...
  return (
    <div className="flex flex-col text-sm justify-center items-center py-12 px-4">
      ...
      <button
        ...
        className=" bg-t_lime-600 px-5 py-2 rounded-md font-bold text-gray-200   hover:text-gray-100 mt-4"
      >
        登入
      </button>
...
export const EmptyStoragePage = () => {
  return (
    <div className="flex flex-col justify-center items-center text-white brightness-50 mt-10">
      ...
      <div className="mt-10">還沒有發布的圖片。</div>
    </div>
  );
};
export const EmptyCollectionPage = () => {
  return (
    <div className="flex flex-col justify-center items-center text-white brightness-50 mt-10">
      ...
      <div className="mt-10">還沒有收藏的圖片</div>
    </div>
  );
};
export const EmptyFollowPage = () => {
  return (
    <div className="flex flex-col justify-center items-center text-white brightness-50 mt-10">
      ...
      <div className="mt-10">還沒有追隨使用者</div>
    </div>
  );
};
...
export const ImageWithFallback = ({ src, alt, fallbackSrc, custom_style }) => {
  ...
  return (
    <img
      ...
      className={`absolute aspect-square top-1/2 left-0 -translate-y-1/2 object-cover w-full h-fulls rounded-full border border-gray-600 ${custom_style}`}
    />
  );
};

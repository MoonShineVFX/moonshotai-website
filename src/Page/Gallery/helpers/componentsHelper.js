      ...
      <form>
        <div className='flex flex-col gap-2'>
          <div className='flex flex-col'>
            <input  type="text" placeholder="即將上線" className='bg-gray-700 rounded-xl py-3 px-2 text-sm' disabled/>
          </div>
          <button type="submit" disabled   className="disabled flex justify-center items-center bg-gray-700 text-white/30 rounded-xl py-3 px-4 text-center  text-xl">
            輸入邀請碼(即將上線)
        ...
        <div className='flex flex-col gap-2'>
          <div className='flex flex-col'>
            <Controller
              ...
              rules={{ required: true }}
              render={({ field }) => (
                <input {...field} type="text" placeholder="邀請碼" className='bg-gray-700 rounded-xl py-3 px-2 text-sm' />
              )}
            />
          </div>
...
export const DisableBuyButton = () =>{
  return (
    <button disabled className="w-full flex justify-center items-center bg-gray-700 text-white/30 rounded-xl py-6 px-4 text-center  text-xl">
      即將開賣
      <MdOutlineTrendingFlat className='ml-2'/>
    </button>
  )

    ...
    <div className="text-white/60 p-4 border-t border-white/20">
      <div className="flex flex-col text-sm  ">
        ...
        <div className=" flex  items-center gap-5 mt-4 ">
          ...
          >
            <img
              src="https://r2.web.moonshine.tw/msweb/moonshotai/web_icons/twitter-x.svg"
              className="min-w-3 w-3  object-contain"
              alt=""
            />
          </a>
          <a
          ...
          <a
            href="https://www.instagram.com/moonshot_ai"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaInstagram size={16} />
          ...
          <a
            href="https://www.facebook.com/groups/547117463595869"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaFacebook size={16} />

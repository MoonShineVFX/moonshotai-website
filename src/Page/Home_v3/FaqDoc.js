    ...
    <div>
      <div className='my-4' id="faq">
        ...
        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>1. 需要下載或安裝特定軟體嗎？</p>
          <p>Moonshot 是建立在 LINE 上面的 AI 生圖機器人，因此只要你擁有 LINE 帳號，加入 Moonshot 好友即可使用！</p>

        </div>

        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>2. 付費進階方案包括哪些額外功能或優勢？</p>
        ...
        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>3. 我可以在圖片上加入文字或標籤嗎？</p>
        ...
        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>4. 是否有常見的疑問解答或教學資源可供參考？</p>
          <p>你可以參考 Moonshot 官網中的 AI 文章，我們會不定時釋出厲害的創作者使用文章，讓大家參考，你還可以加入 Moonshot 的 Line 討論社群，裡面有許多大師能請教、一起交流。</p>
        ...
        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>5. 如何聯繫客 Moonshot 開發團隊？</p>
      ...
      <div className='my-4'>
        ...
        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>1. 推薦序號是什麼？ </p>
          <p>「推薦序號」讓大家可以透過分享，來領取進階帳戶免費體驗。</p>
        </div>

        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>2. 哪裡可以取得推薦序號？ </p>
          <p>至【會員資料 Account】頁面即可取得唷。</p>
        </div>

        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>3. 除了推薦序號外，還有其他機會可以獲得免費進階帳號天數嗎？</p>
          <p>有的！Moonshot 會定時推出不同的活動，只要有參與體驗，都有機會可以獲得免費天數的機會唷，歡迎隨時關注 Moonshot 的社群粉專！</p>
        </div>

        <div className='text-white/90 text-sm space-y-2 my-8'>
          <p className='text-lg'>4. 現在還有邀請碼嗎？邀請碼跟推薦序是一樣的東西嗎？ </p>
      ...
      <div className='my-4' id="">
        ...
        <div className='text-white/90 text-sm space-y-2'>
          <p className='text-lg'>1. 我可以取消訂閱嗎？如何處理退款？ </p>

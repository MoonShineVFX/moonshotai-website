...
function Section_about() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${"https://r2.web.moonshine.tw/msweb/moonshotai/home_images/moon-bg.png"})`,
      }}
    >
        ...
        <div className="w-11/12  rounded-3xl  md:w-1/3 absolute right-1/2 translate-x-1/2 md:translate-x-0 md:right-10 top-32  md:top-1/2 md:-translate-y-1/2 bg-black/60  px-10 md:px-20 py-10">
          <div className="   flex flex-col">
                ...
                >
                  <img
                    src={
                      ...
                      "/images/ver3_images/section01_c01.png"
                    }
                    alt=""
                  />
                </div>
            ...
            <div className="text-white mt-6 text-lg">
              <div className="pt-2">
                Moonshot 是一個結合 Line 機器人的 AI
                繪圖工具。可以輕易地透過對話，產出高質感的 AI 圖。
              </div>
              <div className="pt-2">
                無論是風景、人像、藝術還是科幻風格，都能根據創作者的需求，利用不同的風格模型與工具指令，將想像化為令人驚艷的視覺圖像。準備好了嗎？讓
                Moonshot 陪你一起暢遊 AI 宇宙！
              </div>
            </div>
          </div>
        </div>

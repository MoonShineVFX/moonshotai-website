...
function HomeFooter() {
  ...
  const soical = [
    ...
    {title:'Facebook', link:'https://www.facebook.com/groups/547117463595869/'},
    {title:'Youtube', link:'https://www.youtube.com/channel/UCT0noXFjgZ30lLCwZjJYdgQ'},
  ]

  const join = [
    {title:'Join line community', link:'https://line.me/ti/g2/0nEqJgPJlUZitp5pYpwLeoPKmswnBuzpRGoBnw?utm_source=invitation&utm_medium=link_copy&utm_campaign=default'}
  ]
  ...
  return (
    <div className='text-white/60 '>
      <div className='flex flex-col text-sm  '>
        ...
        <div className=' grid md:grid-cols-4 py-10 space-y-4 md:space-y-0'>
          ...
          <div className='flex flex-col items-center space-y-5 md:space-y-0  md:space-x-7 justify-center text-sm md:text-xs pt-3 md:border-t border-white/30 pb-20 mb:pb-4 '>
            <div className='flex items-center '>  <div className='hidden md:block'>©</div>
              <a href='/' className=' w-20 lg:w-20'>
                ...
                <img src="https://moonshine.b-cdn.net/msweb/moonshotai/home_images/logo-2.png" alt="logo" className='max-w-full block md:hidden' />
              </a>
            </div>

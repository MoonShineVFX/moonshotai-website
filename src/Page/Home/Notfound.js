  ...
  return (
      <div >
        ...
        <div className='flex flex-col relative text-white mx-5 mt-10'>
          <div className='text-xl text-white mx-5 border border-white/50 p-4 rounded-md bg-black/80'>
            <div className='text-3xl font-bold my-6 text-center'>找不到路徑</div>
            <div className='text-lg mt-2'>
            因為從外部瀏覽器登入或找不到頁面的關係，將在3秒後自動跳轉至 Gallery 頁面。
            </div>
            <button className='my-6  p-2 px-4 text-black/80 bg-lime-400 rounded-sm flex items-center gap-2 ml-auto'>Go Gallery <MdArrowRightAlt/> </button>
          </div>

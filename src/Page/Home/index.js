...
function Modal(props) {
  return (
    <div className="modal fixed top-0 left-0 w-full h-screen bg-black/50 z-50" style={{ display: props.show ? "block" : "none" }}>
      <div className="modal-content bg-white w-10/12 md:w-8/12 relative mt-10 py-12 px-10 mx-auto  h-[90vh] overflow-y-auto  overflow-x-hidden">

...
function Header() {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div
        className="w-full md:w-1/2 h-[70vh] md:h-screen text-white relative flex items-center justify-center overflow-hidden drop-shadow-2xl bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#49531F]   to-black-600 "
        ref={vantaRef}
      >
        <div className="text-white font-semibold  text-lg absolute top-0 md:left-0 z-50 flex gap-5 bg-gray-700 rounded-b-xl p-1">
          <Link to="/gallery" class="rounded-full  py-2 px-5 text-base ">
            {" "}
            Gallery{" "}
          </Link>
          {/* <Link to="/price" class="rounded-full  py-2 px-5 text-base" > Price  </Link> */}
          <Link to="/profile" class="rounded-full py-2 px-5 text-base">
            {" "}
            Sign In{" "}
          </Link>
        </div>
        ...
        >
          <div className="flex flex-row items-center mx-auto w-[400px] my-20 md:my-36 justify-center ">
            <div className="w-20 lg:w-[100px] mr-5 hover:translate-y-[1px] cursor-pointer ">
              <img
                ...
                alt=""
                className="min-w-[80px] rounded-full aspect-square"
              />
            </div>
            <div className="w-3/5 text-justify flex flex-col ">
              <div className="text-4xl font-black mb-3">
                <img
                  src={
                    process.env.PUBLIC_URL + "/images/ver2_images/mslogo.svg"
                  }
                  alt=""
                  className="w-full"
                />
              </div>
              <div className=" text-white text-justify w-full tracking-[0.2rem]">
                讓機器人幫你畫出你的想像
              </div>
            </div>
          </div>
          ...
          <div className="my-6 leading-10 hidden ">
            ...
            <div className="flex items-center gap-2">
              {" "}
              <FaCheckCircle /> 支援中文指令
            </div>
            <div className="flex items-center gap-2">
              {" "}
              <FaCheckCircle /> 自由邀請至自己人群組
            </div>
            <div className="flex items-center gap-2">
              {" "}
              <FaCheckCircle /> 超多隱藏功能等你發現
            </div>
            <div className="flex items-center gap-2">
              {" "}
              <FaCheckCircle /> 持續更新，未來有pro版本
            </div>
          </div>
          <div className="flex items-center gap-4 md:gap-6 mt-20 md:mt-36 text-xs md:text-lg hidden">
            ...
            <div className="w-1/3">
              <img
                src={process.env.PUBLIC_URL + "/images/moonshotqr_b.png"}
                alt=""
                className="max-w-full min-w-[80px]"
              />
            </div>
          </div>
          <div className="text-sm text-gray-400 mt-12 hidden">
            *立即加入 MoonShot Line 好友，內有說明引導使用。
          </div>
        </motion.div>
